print("""Hello in our mad libs game!
To start our game, help me define following gaps:

""")


male = input("Male Name: ")
teacher = input("Name of your favorite teacher: ")
exc = input("Exclamation: ")
num = input("Number: ")
plur = input("Plural Objects: ")
stor = input("Store Name: ")
body = input("Body Part: ")
word = input("Silly Word: ")
hol = input("Name of Holiday: ")
celeb = input("Celebrity Name: ")
movie = input("Movie Title: ")
ending = input("Verb Ending in -Ing: ")
dist = input("Amount of Distance: ")
count = input("Country: ")
obj = input("Object: ")
occ = input("Occupation: ")
ani = input("Animal: ")
movie = input("Famous Movie Quote: ")
body2 = input("Body Part: ")
child = input("Children’s Song: ")
adj = input("Adjective: ")
...
SUSPECT: {exc}!  
DETECTIVE That’s right. {num} {plur} were stolen from {stor} and the crime scene has your {body} written ALL over it.
SUSPECT: That is {word}.
DETECTIVE: Where were you on the night of {hol}?
